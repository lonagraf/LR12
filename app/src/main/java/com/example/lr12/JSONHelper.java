...
public class JSONHelper {
    ...
    static boolean exportToJSON(Context context, List<Employee> employees) {
        Gson gson = new Gson();
        DataItems dataItems = new DataItems();
        dataItems.setEmployees(employees);
    ...
    static List<Employee> importFromJSON(Context context){
